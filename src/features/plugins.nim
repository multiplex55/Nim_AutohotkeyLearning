...
method install*(plugin: Plugin, registry: var ActionRegistry,
    ctx: var RuntimeContext) {.base.} = discard
...
proc registerPlugin*(manager: PluginManager, plugin: Plugin,
    registry: var ActionRegistry, ctx: var RuntimeContext) =
  if plugin == nil:
    return
